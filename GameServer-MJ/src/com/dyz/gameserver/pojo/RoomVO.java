...
public class RoomVO {
    ...
    /**
     * 赣州麻将玩法类型 1:上下翻埋地雷 2:上下左右翻精
     */
    private int shangXiaFanType;
    public int getShangXiaFanType() {
		return shangXiaFanType;
	}
	public void setShangXiaFanType(int shangXiaFanType) {
		this.shangXiaFanType = shangXiaFanType;
	}
     ...
     * 赣州麻将通庄、分庄闲
     */
    private boolean tongZhuang;
	public boolean isTongZhuang() {
		return tongZhuang;
	}
	public void setTongZhuang(boolean tongZhuang) {
		this.tongZhuang = tongZhuang;
	}
     ...
     */
    private int pingHu;
	public int getPingHu() {
		return pingHu;
	}
	public void setPingHu(int pingHu) {
		this.pingHu = pingHu;
	}
    ...
    public boolean getQueYiMen() {
        return queYiMen;
    }

    public void setQueYiMen(boolean queYiMen) {
        this.queYiMen = queYiMen;
    }
